<!-- Jesus Eduardo Garcia Rojas 3-1 -->
<?php
                            ...
                            <?php if(count($productos) > 0): ?>
                                <?php foreach($productos as $producto): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index.php?editar=<?php echo $producto['id']; ?>" class="btn btn-sm btn-warning">Editar</a>
                                            <a href="index.php?eliminar=<?php echo $producto['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Estás seguro de eliminar este producto?');">Eliminar</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
